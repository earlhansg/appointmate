  ...
  return (
    <SafeAreaView style={ServiceCheckoutStyle.container}>
      <View style={ServiceCheckoutStyle.headerContainer}>
        <ScrollView stickyHeaderIndices={[1]} scrollEventThrottle={16} showsVerticalScrollIndicator={false}>
          <View
            style={[
              ServiceCheckoutStyle.headerIconContainer
            ]}
          >
            <Image
              source={aircon}
          ...
          >
            <View style={{flexDirection: "row",}}>
              ...
              >
                ...
                <Text
                  style={{ marginTop: 5, fontSize: 13, color: theme.gray.light3 }}
                >
                  Cleaning 1 Cleaning 1 Cleaning 1 Cleaning 1 Cleaning 1 Cleaning
                  1 Cleaning 1
                </Text>
              </View>
              <Text
